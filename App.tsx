...
import { Layout } from './components/drive/Layout';
...
function App() {
    ...
    return (
        <Layout activeTab={currentView} setActiveTab={setCurrentView}>
            <div className="p-6 h-full overflow-y-auto">
                {currentView === 'planner' && (
                    <div className="animate-in fade-in max-w-5xl mx-auto">
                        ...
                        <main>
                            <div className="p-6 bg-gray-800/50 backdrop-blur-sm rounded-lg shadow-lg mb-6 border border-gray-700">
